...
# d = D/M/S => D+(M/60)+(S/60^2) degrees => D.d degrees
#
# \param d Degrees in string format ("D/M'S''" || "D.d")
...
# ("HhMmSSs", "D/M'S''", "HhMmSs")
#
# \param ra Right ascension
# \param dec Declination
# \param mtime Timestamp in microseconds
# \return List with (Right ascension, declination, time) => ("HhMmSSs", "D/M'S''", "HhMmSs")
